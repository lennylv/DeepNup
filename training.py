...
parser.add_argument('-p', '--path', dest='path', type=str, default=r"D:\data\setting1\pickle_H",
...
parser.add_argument('-o', '--out', dest='outPath', type=str, default=r"D:\experiment",
                    help='Output file Path')
parser.add_argument('-e', '--experiments', dest='exp', default='Experiment_C',
